...
//-70, -(162.5+70*2)
	...
	{
		windowRect = Rect(Screen.width-windowSize.x-20,Screen.height-720,windowSize.x,windowSize.y);
	}
	else
	{
...
function OnGUI()
{
	...
	if(csheet) //If the csheet is opened up.
	{
		...
		windowRect=GUI.Window (1, windowRect, DisplayCSheetWindow, "Equipement");
	}
}
